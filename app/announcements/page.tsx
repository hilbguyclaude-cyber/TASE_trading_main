          ...
          <table style={{ width: 'max-content', minWidth: '100%', borderCollapse: 'collapse' }}>
            <thead style={{ background: '#f9fafb' }}>
              <tr>
                ...
                <th style={{ position: 'sticky', left: '80px', background: '#f9fafb', zIndex: 10, minWidth: '180px', padding: '16px 20px', textAlign: 'right', fontSize: '12px', fontWeight: 600, color: '#6b7280', textTransform: 'uppercase', letterSpacing: '0.5px', borderRight: '1px solid #e5e7eb', borderBottom: '1px solid #e5e7eb' }}>שם חברה</th>
                <th style={{ position: 'sticky', left: '260px', background: '#f9fafb', zIndex: 10, minWidth: '300px', padding: '16px 20px', textAlign: 'right', fontSize: '12px', fontWeight: 600, color: '#6b7280', textTransform: 'uppercase', letterSpacing: '0.5px', borderRight: '2px solid #d1d5db', borderBottom: '1px solid #e5e7eb' }}>כותרת</th>
